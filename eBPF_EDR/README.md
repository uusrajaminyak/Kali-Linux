...
This project is a custom Endpoint Detection and Response (EDR) agent build from scratch using eBPF (Extended Berkeley Packet Filter) this EDR directly hooks into Linux Kernel to observe and enforce security policies in real-time with minimal overhead.


It features Deep Visibility and Active Enforcement
